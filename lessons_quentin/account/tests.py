...
class TestAccountViews(TestCase):
    ...
    def setUp(self):
        ...
        self.data = {'name': 'Test_Post', 'email': 'testpost@gmail.com', 'password': 'Maman246', 'address': '25 rue de la Corniche'}
        
    def test_account_POST(self):
        response_1 = self.client.post(reverse('account:post_account'), data=self.data, json=json.dumps(self.data))
        ...
        response_2 = self.client.post(reverse('account:post_account'), data=self.data, json=json.dumps(self.data))
